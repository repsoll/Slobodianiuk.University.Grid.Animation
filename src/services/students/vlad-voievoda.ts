...
function generateETCLOADPROJECT(): IFrame[] {
    ...
    const lettersOk: IPixelState[] = [
        { x: 12, y: 2, color: Colour.White }, { x: 12, y: 3, color: Colour.White }, { x: 12, y: 4, color: Colour.White },
        { x: 13, y: 2, color: Colour.White }, { x: 13, y: 4, color: Colour.White },
        { x: 14, y: 2, color: Colour.White }, { x: 14, y: 3, color: Colour.White }, { x: 14, y: 4, color: Colour.White },
    ];
    ...
    for (let frameNumber = 0; frameNumber < Constants.MaxTotalFrames; frameNumber++) {
        ...
        const showOk = frameNumber % 30 >= 20;
